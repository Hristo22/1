...
function validaEdad() {
    ...
    if (!elemento.checkValidity()) {
        ...
        if(elemento.validity.rangeOverflow) {
            error2(elemento, "Valor mayor que el indicado, debe ser menor que 100");
        }
        if(elemento.validity.rangeUnderflow) {
            error2(elemento, "Valor menor que el indicado, debe ser mayor o igual que 18");
        }
...
function validaTelefono() {
    ...
    if (!elemento.checkValidity()) {
        ...
        if(elemento.validity.patternMismatch) {
            error2(elemento, "El numero debe tener 9 caracteres");
        }
